<?php if (!defined('THINK_PATH')) exit();?>window._plugin_source_domin = "<?php echo ($source_domin); ?>";
window._plugin_editor_path_ = 'http://localhost/anthink/Public/Plugins/qiniuue/';
window._plugin_editor_token_ = '/anthink/index.php/plugin/ueditor/getToken.js?token=<?php echo ($token); ?>';
window._plugin_editor_server = '/anthink/index.php/plugin/ueditor/server.js?token=<?php echo ($token); ?>';
